...
describe('src/pages/LeadManagementSystem/Dashboard/DetailPhase2/elements/FormValidate/elements/PickSalesTeam/hooks/useAction', () => {
  afterEach(cleanup);
  ...
  test('run properly', async () => {
    ...
    await act(async () => {
      ...
      await result.current.onSubmit({ amMapping: [{}] });
