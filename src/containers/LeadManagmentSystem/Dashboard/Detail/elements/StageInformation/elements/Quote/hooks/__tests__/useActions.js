...
describe('src/pages/LeadManagementSystem/Dashboard/Detail/elements/StageInformation/elements/Quote/hooks/useActions', () => {
  afterEach(cleanup);
  ...
  test('run properly', async () => {
    ...
    await act(async () => {
      ...
      await result.current.onClickRowTable({ scQuoteId: '123' });
