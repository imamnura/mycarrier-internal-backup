...
import { updateStatusNonBulk } from '../../../../../../_repositories/repositories';
...
describe('src/containers/Neucentrix/VisitNeucentrix/Detail-v2/lib/forms/UpdateStatusForm/hooks', () => {
  ...
  test('run properly', async () => {
    updateStatusNonBulk.mockResolvedValue({ data: {} });
  ...
  test('fetch rejected', async () => {
    updateStatusNonBulk.mockRejectedValue({ message: 'error' });
