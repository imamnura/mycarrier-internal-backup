...
const TextEditorComp = (props) => {
  const { onChange, value, tab, previewMode, editableDescInitialValue } = props;
  ...
  const [editableDesc, setEditableDesc] = useState(editableDescInitialValue);
...
TextEditorComp.propTypes = {
  editableDescInitialValue: PropTypes.bool,
