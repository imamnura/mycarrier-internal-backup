      ...
      content: [
        {
          ...
          properties: {
            ...
            schema: [
              ...
              ...additionalInformation[productName],
            ],
          },
        },
        {
          ...
          properties: {
            ...
            schema: [
              ...
              {
                name: 'activationDoc',
                label: ['smarthand'].includes(productName)
                  ? 'Order Confirmation'
                  : 'BASO',
              },
      ...
      content: [
        {
          ...
          properties: {
            ...getGameQooStepper(data?.status),
            steps: gameQooStep[productName],
          },
        },
        {
          type: 'worklog',
          ...
          properties: {
            data: getGameQooWorklog(data?.worklog, data?.productName),
          },
        },
      ],
    },
