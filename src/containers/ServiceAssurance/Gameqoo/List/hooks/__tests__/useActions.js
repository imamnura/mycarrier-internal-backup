...
import {
  getList,
  downloadList,
} from '@containers/ServiceAssurance/Gameqoo/_repositories/repositories';
...
describe('src/containers/ServiceAssurance/Gameqoo/List/hooks/useActions', () => {
  afterEach(cleanup);
  beforeAll(() => {
    useRouter.mockReturnValue({
      pathname: route.gameqoo('list'),
      push: jest.fn(),
    });
