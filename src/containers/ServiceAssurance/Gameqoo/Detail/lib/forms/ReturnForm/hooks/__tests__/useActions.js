...
import { rejectTicket } from '@containers/ServiceAssurance/Gameqoo/_repositories/repositories';

jest.mock('@utils/hooks/usePopupAlert');
jest.mock('@utils/hooks/usePopupConfirmation');
jest.mock('@containers/ServiceAssurance/Gameqoo/_repositories/repositories');

describe('src/containers/ServiceAssurance/Gameqoo/Detail/lib/forms/ReturnForm/hooks/useActions', () => {
  afterEach(cleanup);
  beforeAll(() => {
