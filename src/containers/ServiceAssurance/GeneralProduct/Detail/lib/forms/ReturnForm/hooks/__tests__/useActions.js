...
import { rejectTicket } from '@containers/ServiceAssurance/GeneralProduct/_repositories/repositories';
...
describe('src/containers/ServiceAssurance/GeneralProduct/Detail/lib/forms/ReturnForm/hooks/useActions', () => {
  afterEach(cleanup);
  beforeAll(() => {
