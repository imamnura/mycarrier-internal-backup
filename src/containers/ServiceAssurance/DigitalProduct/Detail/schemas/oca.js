...
export const ocaDetailSchema = (data, other) => [
  {
      ...
      },
      {
        ...
        properties: {
          ...
          schema: [
            ...
            // { name: 'whatsapp', label: 'WHATSAPP BUSINESS PHONE NUMBER' },
            { name: 'emailUser', label: 'EMAIL USER' },
...
export const ocaDataMapping = (data) => ({
  ...data,
