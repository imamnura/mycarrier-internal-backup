...
// LEGACY - antaresEazyDetailSchema - no longer used (change to file _base)
// last usage : July 15th 2024
// note : can be use again when there's a need for custom
export const antaresEazyDetailSchema = (data, other) => [
  {
...
export const antaresEazyDataMapping = (data) => ({
  ...data,
