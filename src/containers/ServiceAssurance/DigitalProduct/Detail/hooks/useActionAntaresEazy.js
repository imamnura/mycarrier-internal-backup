...
const useActionAntaresEazy = () => {
  ...
  const approveTicket = async () => {
    ...
    try {
      ...
      success &&
        setSuccessAlert({
          message: `Antares Eazy ticket successfully escalated to DOA & approved`,
      ...
      setFailedAlert({
        message:
          err?.message ||
          `Antares Eazy ticket unsuccessfully escalated to DOA & approved`,
      });
    }
  };
  ...
  const onApprove = () => {
    setConfirmation({
      ...
      message: `Are you sure want to escalated this issue Antares Eazy ticket to DOA?`,
    });
  };
  ...
  const onClickModalReturn = () => {
    setModalReturn({
      ...
      success: 'Antares Eazy ticket successfully rejected',
      confirmation: 'Are you sure want to reject this Antares Eazy ticket?',
    });
  };
...
export default useActionAntaresEazy;
