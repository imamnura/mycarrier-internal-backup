...
const useActionPijar = () => {
  ...
  const approveTicket = async () => {
    ...
    try {
      ...
      success &&
        setSuccessAlert({
          message: `Pijar ticket successfully escalated to DOA & approved`,
      ...
      setFailedAlert({
        message:
          err?.message ||
          `Pijar ticket unsuccessfully escalated to DOA & approved`,
      });
    }
  };
  ...
  const onApprove = () => {
    setConfirmation({
      ...
      message: `Are you sure want to escalated this issue Pijar ticket to DOA?`,
    });
  };
  ...
  const onClickModalReturn = () => {
    setModalReturn({
      ...
      success: 'Pijar ticket successfully rejected',
      confirmation: 'Are you sure want to reject this Pijar ticket?',
    });
  };
