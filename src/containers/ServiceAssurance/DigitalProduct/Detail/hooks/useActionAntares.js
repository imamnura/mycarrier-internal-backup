...
const useActionAntares = () => {
  ...
  const approveTicket = async () => {
    ...
    try {
      ...
      success &&
        setSuccessAlert({
          message: `Antares IoT ticket successfully escalated to DOA & approved`,
      ...
      setFailedAlert({
        message:
          err?.message ||
          `Antares IoT ticket unsuccessfully escalated to DOA & approved`,
      });
    }
  };
  ...
  const onApprove = () => {
    setConfirmation({
      ...
      message: `Are you sure want to escalated this issue Antares IoT ticket to DOA?`,
    });
  };
  ...
  const onClickModalReturn = () => {
    setModalReturn({
      ...
      success: 'Antares IoT ticket successfully rejected',
      confirmation: 'Are you sure want to reject this Antares IoT ticket?',
    });
  };
...
export default useActionAntares;
