...
const useActionNetmonk = () => {
  ...
  const approveTicket = async () => {
    ...
    try {
      ...
      success &&
        setSuccessAlert({
          message: `Netmonk ticket successfully escalated to DOA & approved`,
      ...
      setFailedAlert({
        message:
          err?.message ||
          `Netmonk ticket unsuccessfully escalated to DOA & approved`,
      });
    }
  };
  ...
  const onApprove = () => {
    setConfirmation({
      ...
      message: `Are you sure want to escalated this issue Netmonk ticket to DOA?`,
    });
  };
  ...
  const onClickModalReturn = () => {
    setModalReturn({
      ...
      success: 'Netmonk ticket successfully rejected',
      confirmation: 'Are you sure want to reject this Netmonk ticket?',
    });
  };
...
export default useActionNetmonk;
