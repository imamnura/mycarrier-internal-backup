...
const useActionOCA = () => {
  ...
  const approveTicket = async () => {
    ...
    try {
      ...
      success &&
        setSuccessAlert({
          message: `OCA ticket successfully escalated to DOA & approved`,
      ...
      setFailedAlert({
        message:
          err?.message ||
          `OCA ticket unsuccessfully escalated to DOA & approved`,
      });
    }
  };
  ...
  const onApprove = () => {
    setConfirmation({
      ...
      message: `Are you sure want to escalated this issue OCA ticket to DOA?`,
    });
  };
  ...
  const onClickModalReturn = () => {
    setModalReturn({
      ...
      success: 'OCA ticket successfully rejected',
      confirmation: 'Are you sure want to reject this OCA ticket?',
    });
  };
