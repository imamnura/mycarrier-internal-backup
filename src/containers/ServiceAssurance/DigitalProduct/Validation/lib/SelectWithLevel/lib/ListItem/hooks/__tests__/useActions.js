...
import { getSymptomp } from '@containers/ServiceAssurance/DigitalProduct/_repositories/repositories';

jest.mock(
  '@containers/ServiceAssurance/DigitalProduct/_repositories/repositories',
);

describe('src/containers/ServiceAssurance/DigitalProduct/Validation/lib/SelectWithLevel/lib/ListItem/hooks', () => {
  afterEach(cleanup);
